...
export const StatByType = ({ total, label, type }: StatByTypeProps) => {
  ...
  return (
    <div className="flex gap-3 p-5 rounded-[20px] w-[140px] md:w-full bg-card shadow-md items-center">
      <div
        className={`${color} size-[50px] md:size-[70px] rounded-full p-2 md:p-5`}
      >
        {icon}
      </div>
